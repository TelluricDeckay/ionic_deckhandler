# Contributing to ionic-deckhandler

## Bug Reports and Feature Requests

Anyone may [open an
issue](https://github.com/TelluricDeckay/ionic-deckhandler/issues).
...
* [Configuring a remote for a fork](https://help.github.com/articles/configuring-a-remote-for-a-fork/)
  * For step 3 on that page, use https://github.com/TelluricDeckay/ionic-deckhandler.git for the URL.
